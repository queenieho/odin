...
(def communities
  [{:value           "414bryant"
    ...
    :community       "You’ll be joining a diverse, low-key community who takes pride in representing Oakland and spreading the Town’s unique cultural legacy. We are generous in spirit and welcome people from all walks of life to live with us. You’ll frequently find the common spaces occupied with quiet studiers during the day and people cooking and watching TV at night, with the occasional fun event or craft night."
    :amenities       [{:label "Private, furnished bedroom"
                       :icon  "/assets/images/ptm/icons/ic-atom.svg"}
   ...
   {:value           "2072mission"
    ...
    :price           1400
    :units-available 5
    :introduction    "Join our community in The Mission District, an eclectic and diverse neighborhood steps from the business district, nightlife, shops, and transportation. Just a short bike ride or drive and you can enjoy a picnic at Lake Merritt, a stroll through the Oakland Musuem of California, or kick back to watch a flick on a couch at The New Parkway."
    :building        "This medium building has 2 floors, each boasting 2,300 square feet. There are 122 total units. The architecture is blah blah more details about the building."
    :neighborhood    "Something cool about The Mission having lots of arts and mexican food."
    :community       "We party hard and yoga."
    :amenities       [{:label "Private, furnished bedroom"
                       :icon  "/assets/images/ptm/icons/ic-atom.svg"}
                      {:label "High-speed wifi"
                       :icon  "/assets/images/ptm/icons/ic-atom.svg"}
...
<br>
`:introduction` (string) - brief introduction to the community.
<br>
`:building` (string) - Description of the building.
<br>
`:neighborhood` (string) - Description of the neighborhood.
<br>
`:community` (string) - Description of the community itself. To get a feel of the type of people living there.
<br>
